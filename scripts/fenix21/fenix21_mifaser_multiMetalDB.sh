...
#SBATCH --job-name="fenix21_multiMetDB"
...
#SBATCH --mem=15G
#SBATCH --array=1-23
#SBATCH --output=/ibiscostorage/dcorso/flavia_migliaccio/metal_transporters/slurm_logs/results_multiMetalDB/slurm-%A_%a.out
